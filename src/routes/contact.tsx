...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      { title: "Contact — Kokstad College" },
      {
        name: "description",
        content: "Get in touch with Kokstad College. Address, phone, email and contact form.",
      },
    ],
  }),
});
    ...
    <div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-4 grid lg:grid-cols-2 gap-10">
            ...
            <ul className="mt-6 space-y-5">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    The Avenue Street, Kokstad, KwaZulu-Natal, 4700
                  </p>
                  <p className="text-muted-foreground text-sm">P.O. Box 78, Kokstad, 4700</p>
                </div>
              </li>
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:0397272187"
                    className="text-muted-foreground text-sm hover:text-navy"
                  >
                    039 727 2187
                  </a>
                </div>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:principal@kokstadcollege.co.za"
                    className="text-muted-foreground text-sm hover:text-navy break-all"
                  >
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Monday – Friday, 07:30 – 16:00</p>
                </div>
              </li>
            </ul>
            <a href="#" className="mt-6 inline-flex items-center gap-2 text-navy hover:text-gold">
          ...
          <form
            onSubmit={onSubmit}
            className="bg-card border rounded-xl p-6 md:p-8 space-y-4 h-fit"
          >
